...
$string['notesdesc'] = 'Para aplicar cualquier cambio en la configuración presione "Guardar cambios" al final de la página. Si no tiene habilitado el modo de "Diseñador de Temas", quizás necesite forzar la actualización entrando en Administración del sitio ► Desarrollo ►  <a href="purgecaches.php">"Purgar todas las Cachés"</a>.';
...
$string['sociallinks'] = '... et dans les Sociales: ';
$string['powered'] = 'Avec la puissance de: ';
$string['original_theme'] = 'Diseño inspirado en un tema original de Patrick Malley & Mary Evans';
$string['lastpageupdate'] = 'Cette page a eté modifié par dernier fois le ';
$string['thanksvisit'] = 'Merci pour votre confiance';
$string['reservedrights'] = 'Réservés tous droits';
$string['contact'] = 'Contacté avec nous: ';
